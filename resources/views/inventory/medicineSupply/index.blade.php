...
@section('content')
                                            ...
                                            <td>{{  $medicine->source }}</td> --}}
                                                ...
                                                <td style="white-space:nowrap;">
                                                    <button type=" button"
                                                        ...
                                                        data-toggle="modal" data-target=".med_add_stock"
                                                        data-target=".med_add_stock" data-uid="{{ $medicine->id }}"
                                            ...
                                            <tr style="border: 1px solid #033571;">
                                                ...
                                                <td style="white-space:nowrap;">
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-description="{{ $supply->description }}"> <i
                                                            class="far fa-edit"></i> Add Stock
                                                    </button>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center">
                                <table class="table mt-4"
                                    ...
                                    <thead style="background-color: #033571;">
                                        <tr>
                                            <th style="color:white; white-space:nowrap;">Type of Medicine</th>
                                            <th style="color:white;">Action</th>

                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($medicince_categories as $medicince_category)
                                            <tr>

                                                <td>
                                                    {{ $medicince_category->category_name }}
                                                </td>
                                                <td>
                                                    <button type="button"
                                                        class="btn btn-icon icon-left mr-3 btn-outline-primary category-edit"
                                                        data-toggle="modal" data-target=".edit"
                                                        data-uid="{{ $medicince_category->id }}"
                                                        data-cat="{{ $medicince_category->category_name }}">
                                                        <i class="far fa-edit"></i>
                                                        Edit
                                                    </button>
    ...
    <!-- Category Modal edit-->
    <div class="modal fade edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle" style="color: #033571;">Edit Category</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input style="color:#033571; font-weight: 600;" type="text"
                                                name="med_class" class="form-control" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input style="color:#033571; font-weight: 600;" type="text"
                                                name="brand_name" class="form-control" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input style="color:#033571; font-weight: 600;" type="text"
                                                name="sup_name" class="form-control" disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input style="color:#033571; font-weight: 600;" type="text"
                                                name="description" class="form-control" disabled>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade med_add_stock" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input style="color:#033571; font-weight: 600;" class="form-control" name="med_class"
                                        tabindex="1" disabled>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input style="color:#033571; font-weight: 600;" class="form-control"
                                        name="type_of_medicine" tabindex="1" disabled>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input style="color:#033571; font-weight: 600;" class="form-control" name="dosage"
                                        tabindex="1" disabled>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input style="color:#033571; font-weight: 600; border-color:#033571;" type="number"
                                        placeholder="Enter Quatity " class="form-control" name="stock" tabindex="1">
    ...
    <!-- medicine add stock Modal-->
    <div class="modal fade supply_add_stock" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog  modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Supply</label>
                                    <input style="color:#033571; font-weight: 600;" class="form-control" name="supply"
                                        tabindex="1" disabled>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input style="color:#033571; font-weight: 600;" class="form-control"
                                        name="description" tabindex="1" disabled>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.category-edit').each(function() {
                $(this).click(function(event) {
                    $('#update').attr("action", "/medicine_category/update/" + $(this).data('uid') + "");
                    $('input[name="category"]').val($(this).data('cat'));
